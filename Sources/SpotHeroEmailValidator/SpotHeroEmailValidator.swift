...
public class SpotHeroEmailValidator: NSObject {
    ...
    @objc public func autocorrectSuggestion(for emailAddress: String) throws -> String {
        ...
        return try self.autocorrectSuggestion(for: emailAddress)
    }

    private func autocorrectSuggestion(for emailAddress: String, withParts emailParts: EmailParts) throws -> String? {
...
//        }
//
//        let emailParts = self.splitEmailAddress(emailAddress)
//
...
//        return true
    ...
    private func closestString(for string: String, fromArray array: [String], withTolerance tolerance: Float) -> String? {
        ...
        for arrayString in array {
            ...
            if distance < closestDistance && Float(distance / string.count) < tolerance {
    ...
    private func splitEmailAddress(_ emailAddress: String) throws -> EmailParts {
        ...
        guard let domainParts = emailAddressParts.last?.split(separator: "."), domainParts.count >= 2 else {
